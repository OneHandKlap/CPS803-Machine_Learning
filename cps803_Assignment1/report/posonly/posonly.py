...
def main(train_path, valid_path, test_path, save_path):
    ...
    # util.plot(test_x, test_y, classifier.theta,'part_a.png')
    ...
    # util.plot(test_x, test_y, classifier.theta,'part_b.png')
    ...
    util.plot(test_x, test_y, classifier.theta,'part_c.png',correction)
